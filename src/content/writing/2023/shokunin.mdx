...
I first came across the Japanese word _shokunin_ (<Ruby base="職" text="しょく" /><Ruby base="人" text="にん" />) when I watched a [documentary](https://www.youtube.com/watch?v=NfdGGTb5_Ts) about the accomplished bonsai artist Ryan Neil, the founder of [Bonsai Mirai](https://bonsaimirai.com/) outside Portland, Oregon.
...
_Shokunin_ are a people who love their craft and work, have high work moral and discipline. They repeat the same processes over and over. They are proud of their work and try to improve (<Ruby base="改" text="かい" /><Ruby base="善" text="ぜん" />, _kaizen_) constantly and strive for perfection. They are aware that they’ll never reach perfection, but follow its path nevertheless for their whole life.
...
This is called _shokunin kishitsu_ (<Ruby base="職" text="しょく" /><Ruby base="人" text="にん" /><Ruby base="気" text="き" /><Ruby base="質" text="しつ" />), the spirit of a true artisan.
...
I think that _shokunin kishitsu_ has its roots in the Taoist philosophy. Japan was influenced by two major religions, by Shintoism (<Ruby base="神" text="しん" /><Ruby base="道" text="とう" />, Shintō) and Buddhism (<Ruby base="仏" text="ぶっ" /><Ruby base="教" text="きょう" />, Bukkyō). The latter is influenced by Confucianism (<Ruby base="儒" text="じゅ" /><Ruby base="教" text="きょう" />, Jukyō) and Taoism (<Ruby base="道" text="どう" /><Ruby base="教" text="きょう" />, Dōkyō).
...
<YouTube id="X1jot6kgFOs" />

This documentary traces the making of the [Higonokami](https://grokipedia.com/page/Higonokami), a traditional Japanese folding knife whose production process has been preserved since the Meiji era. The clip follows the craftsmen of the Nagao Hiroshi factory in Miki, Hyogo Prefecture, showing every step — from hand-forging the blade to riveting the brass handle — unchanged across generations.
