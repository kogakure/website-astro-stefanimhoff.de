...
<Banner summary="Legend" open>
  <Platform kind="iphone" /> iPhone/iPad • <Platform kind="desktop" /> Desktop •{" "}
  <Platform kind="appletv" /> Apple TV • <Platform kind="web" /> Web
</Banner>
...
### Things <Platform kind="iphone" /> <Platform kind="desktop" />
...
### DEVONthink <Platform kind="iphone" /> <Platform kind="desktop" />
...
### Obsidian <Platform kind="iphone" /> <Platform kind="desktop" />
...
### Apple Calendar <Platform kind="iphone" /> <Platform kind="desktop" />

[Apple Calendar](https://support.apple.com/guide/calendar/welcome/mac) is the only calendar I use. It looks beautiful and can be integrated with Exchange servers, Google Calendar, and other calendar providers. My calendars are currently stored in iCloud, but I’m excited to move them to [Proton Mail](https://protonmail.com/), as soon as the Bridge supports (hopefully) their new encrypted calendar.

### Itsycal <Platform kind="desktop" />
...
### Apple Numbers <Platform kind="iphone" /> <Platform kind="desktop" />
...
### Bartender <Platform kind="desktop" />
...
### Time Sink <Platform kind="desktop" />
...
### Apple Workflow <Platform kind="iphone" />
...
### iA Writer <Platform kind="iphone" /> <Platform kind="desktop" />
...
### Affinity <Platform kind="iphone" /> <Platform kind="desktop" />

I worked with and owned Adobe Photoshop and Adobe Illustrator for over 15 years, and use Sketch at work. But [Affinity](https://www.affinity.studio/) is my tool of choice for everything I design: Websites, UI, flyers, and logos.

I switched away from Adobe when they started forcing people to their cloud solutions and making it impossible to buy a new version every few years, but instead have to pay monthly “rent”.

I use the iPad version and soon plan to buy a big iPad Pro with the Apple Pencil to create even cooler things with Affinity.

I also use it to work on photos or photo manipulations, I use Affinity.
...
Affinity is also an incredibly powerful DTP tool to replace Adobe InDesign or Quark Express. I started working with it, but I plan to create and lay out a book with it.
...
### MindNode <Platform kind="iphone" /> <Platform kind="desktop" />
...
### Typeface <Platform kind="desktop" />
...
### Instagram <Platform kind="iphone" /> <Platform kind="web" />
...
### GitHub <Platform kind="iphone" /> <Platform kind="desktop" /> <Platform kind="web" />
...
### Kaleidoscope <Platform kind="desktop" />
...
### Image Shrinker <Platform kind="desktop" />
...
### Integrity <Platform kind="desktop" />
...
### Feedbin <Platform kind="iphone" /> <Platform kind="web" />
...
### Reeder <Platform kind="iphone" /> <Platform kind="desktop" />
...
### Raindrop.io (Pro) <Platform kind="iphone" /> <Platform kind="desktop" /> <Platform kind="web" />
...
### Readwise <Platform kind="iphone" /> <Platform kind="web" />
...
### 𝕏 (Formerly Twitter) <Platform kind="iphone" /> <Platform kind="desktop" /> <Platform kind="appletv" /> <Platform kind="web" />
...
### Apple Messages <Platform kind="iphone" /> <Platform kind="desktop" />
...
### Apple FaceTime <Platform kind="iphone" /> <Platform kind="desktop" />

[FaceTime](https://apps.apple.com/app/facetime/id1110145091) is the video chat messenger I use with my family.

### Proton Mail (Unlimited) <Platform kind="iphone" /> <Platform kind="web" />

[Proton Mail](https://protonmail.com/) is my main email provider, end-to-end encrypted emails. I stopped using Gmail as my main email provider years ago.

### Apple Mail <Platform kind="desktop" />

I use Apple Mail on Desktop to connect to my work email on an Exchange server and my Proton Mail server via the [Proton Mail Bridge](https://proton.me/mail/bridge).

### Signal <Platform kind="iphone" /> <Platform kind="desktop" />
...
### Telegram <Platform kind="iphone" /> <Platform kind="desktop" />
...
### Session <Platform kind="iphone" /> <Platform kind="desktop" />
...
### Brave Browser <Platform kind="iphone" /> <Platform kind="desktop" />
...
### Firefox (Developer Edition) <Platform kind="iphone" /> <Platform kind="desktop" />
...
### Spotify <Platform kind="iphone" /> <Platform kind="desktop" /> <Platform kind="appletv" /> <Platform kind="web" />
...
### Sonos <Platform kind="iphone" /> <Platform kind="desktop" />
...
### YouTube <Platform kind="iphone" /> <Platform kind="web" />
...
### Odysee/LBRY <Platform kind="iphone" /> <Platform kind="desktop" /> <Platform kind="web" />
...
### IMDb <Platform kind="iphone" /> <Platform kind="web" />
...
### WerStreamtEs <Platform kind="iphone" /> <Platform kind="web" />
...
### Netflix <Platform kind="iphone" /> <Platform kind="appletv" />
...
### Prime Video <Platform kind="iphone" /> <Platform kind="appletv" />
...
### Apple Photos <Platform kind="iphone" /> <Platform kind="desktop" />
...
### QuickTime Player <Platform kind="desktop" />
...
### VLC <Platform kind="iphone" /> <Platform kind="desktop" />
...
### Shazam <Platform kind="iphone" />

I use [Shazam](https://www.shazam.com/) for one case: To recognize songs and find them on Spotify.

## Security & Privacy

### Proton Pass <Platform kind="iphone" /> <Platform kind="desktop" /> <Platform kind="web" />
...
### Proton VPN <Platform kind="iphone" /> <Platform kind="desktop" /> <Platform kind="appletv" /> <Platform kind="web" />
...
### Cryptomator <Platform kind="iphone" /> <Platform kind="desktop" />
...
### Duolingo (Plus) <Platform kind="iphone" /> <Platform kind="web" />
...
### Shirabe Jisho <Platform kind="iphone" /> <Platform kind="web" />
...
### Kindle <Platform kind="iphone" /> <Platform kind="desktop" />
...
### Health Mate <Platform kind="iphone" /> <Platform kind="web" />
...
### InsightTimer <Platform kind="iphone" />
...
### iFinance <Platform kind="iphone" /> <Platform kind="desktop" />
...
### Stocks <Platform kind="iphone" /> <Platform kind="desktop" />
...
### Netatmo <Platform kind="iphone" /> <Platform kind="web" />
...
### Weather Pro <Platform kind="iphone" />
...
### RainToday <Platform kind="iphone" />
...
### SolarWatch <Platform kind="iphone" />
...
### Hue <Platform kind="iphone" /> <Platform kind="desktop" />
...
### Apple Maps <Platform kind="iphone" /> <Platform kind="desktop" />
...
### DeepL <Platform kind="iphone" /> <Platform kind="desktop" /> <Platform kind="web" />

[DeepL](https://www.deepl.com/translator) is my favorite translation app.

### Dropbox (Plus) <Platform kind="iphone" /> <Platform kind="desktop" /> <Platform kind="web" />
...
### iCloud <Platform kind="iphone" /> <Platform kind="desktop" /> <Platform kind="web" />
...
### AppCleaner <Platform kind="desktop" />
...
### Find My <Platform kind="iphone" /> <Platform kind="desktop" />
...
### Komoot <Platform kind="iphone" /> <Platform kind="web" />
...
### Citymapper <Platform kind="iphone" /> <Platform kind="web" />
...
### DHL Paket <Platform kind="iphone" />
