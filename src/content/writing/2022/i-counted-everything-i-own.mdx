...
charts: true
cover: ../../../assets/images/cover/i-counted-everything-i-own.webp
tags: ["self-improvement", "minimalism", "personal"]
---
...
import {
  ...
  categories,
  options,
} from "../../../data/writing/i-counted-everything-i-own.ts";
...
<Figure caption="Things vs. Consumables" size="regular">
...
<Figure caption="Rooms" size="regular">
...
<Figure caption="Categories" size="regular">
