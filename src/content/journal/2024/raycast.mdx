...
My application navigation is a combination of <kbd>hyper</kbd> plus a letter, like <kbd>hyper</kbd> <kbd>b</kbd> for the [Brave](https://brave.com/) browser or <kbd>hyper</kbd> <kbd>t</kbd> for [Things](https://culturedcode.com/things/), for example. I have 19 of these shortcuts for the apps I use all the time, the rest I open with Raycast over the search.
