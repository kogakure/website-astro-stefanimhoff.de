...
import EmailLink from "../components/content/EmailLink.tsx";
export const components = mapping;

## Contact

Stefan Imhoff<br /><><EmailLink data-domain="stefanimhoff" data-name="hey" data-tld="de" text="hey@stefanimhoff.de" client:load /></>
...
The essays in my [Writing](/writing/) on this website have a [Creative Commons](https://creativecommons.org/licenses/by-nc-sa/4.0/) license.
