...
- Creating AI Art 🤖 with [Stable Diffusion](https://stability.ai/blog/stable-diffusion-public-release) and posting my best work on [Instagram](https://www.instagram.com/kogakure.ai.art/) 🖼️
...
- Connecting ideas with the [Zettelkasten](https://en.wikipedia.org/wiki/Zettelkasten) 🗃️ note-taking methods, using [Obsidian](https://obsidian.md/)
