	...
	describe('sortByDate', () => {
		it('should sort posts by date descending (newest first)', () => {
			const posts = [
				...
				createMockPost({
					data: { title: 'Middle', date: new Date('2022-01-01'), tags: [] },
				}),
			];
		...
		it('should handle posts with same date', () => {
			const posts = [
				createMockPost({
					data: { title: 'Post A', date: new Date('2024-01-01'), tags: [] },
				}),
				createMockPost({
					data: { title: 'Post B', date: new Date('2024-01-01'), tags: [] },
				}),
			];
		...
		it('should handle future dates', () => {
			const posts = [
				...
				createMockPost({
					data: { title: 'Future', date: new Date('2030-01-01'), tags: [] },
				}),
